...
mv messages.png $HOME/Pictures/messages.png

cd ;

nativefier -n "messages" -p linux -a x64 --counter --bounce -i ~/Pictures/messages.png --honest --disable-dev-tools --single-instance --tray https://messages.google.com/web

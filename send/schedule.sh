...
echo DISPLAY=:0 zenity --warning --text="$answer_content" --title="$answer_title" | at "$answer_time1"

if test "$answer_more" == "y"; then
	echo DISPLAY=:0 zenity --warning --text="$answer_content" --title="$answer_title" | at "$answer_time2"
	if test "$answer_more2" == "y"; then
		echo DISPLAY=:0 zenity --warning --text="$answer_content" --title="$answer_title" | at "$answer_time3"
	fi
else
	exit 0
fi
